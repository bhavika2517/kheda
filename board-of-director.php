...
<section class="page-header" style="background-image: url(images/background/board-of-director.webp);">
	<div class="container">
		<h2>BOARD OF DIRECTOR</h2>
		<ul class="thm-breadcrumb">
			<li><a href="index.html">Home</a></li>
			<li><span>&gt;</span></li>
			<li><span>BOARD OF DIRECTOR</span></li>
		</ul>
	</div>
</section>
...
<section class="team-one-section">
	<div class="container">
		<div class="row">
			<div class="col-xl-3 col-lg-3 col-md-6">
				...
				<div class="team-one-single wow fadeInLeft animated" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInLeft;">
					<div class="team-one-img">
						<img src="images/board-of-director/bod-image.webp" alt="">
